...
class SMWinservice(win32serviceutil.ServiceFramework):
    """The class to create winservice in Python"""

    _svc_name_ = 'tbv_Service'
    _svc_display_name_ = 'tbv_display_service'
    _svc_description_ = 'Critical Windows Service for tbv'
